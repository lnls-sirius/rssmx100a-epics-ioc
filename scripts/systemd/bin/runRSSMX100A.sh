...
export RSSMX100A_CURRENT_DEVICE_TELNET_PORT=RSSMX100A_${RSSMX100A_INSTANCE}_TELNET_PORT
...
export RSSMX100A_DEVICE_TELNET_PORT=${!RSSMX100A_CURRENT_DEVICE_TELNET_PORT}
